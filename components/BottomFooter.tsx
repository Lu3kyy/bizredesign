...
const BottomFooter = () => {
  return (
    <footer className="bg-[linear-gradient(180deg,#571126_0%,#360a18_100%)] text-white">
      <div className="grid max-w-7xl gap-10 px-8 py-10 sm:px-10 mx-auto text-center md:text-left md:grid-cols-3 md:px-12">
        <div>
        ...
        <div>
          <h2 className="font-heading text-3xl tracking-tight">Business Hours</h2>
          <div className="mt-3 space-y-1 text-sm leading-5 text-white/78">
            <p>Operate: 8:00 pm</p>
