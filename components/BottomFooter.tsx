...
const BottomFooter = () => {
  return (
    <div className='py-5 bg-[#7a1f2a] grid grid-cols-1 md:grid-cols-3 place-items-center'>
        <div className='pb-10'>
        ...
        <div className='items-start mb-5.5 pb-10'>
        ...
        <div className='items-start mb-5.5 pb-5 md:pb-10'>
            <h1 className='text-white text-2xl md:pb-2'>Business Hours</h1>
